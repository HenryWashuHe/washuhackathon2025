  ...
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={2}
        d="M20 7c0 7-4 13-8 13s-8-6-8-13c0-1.5 1-3 2-4 2-2 4-3 6-3s4 1 6 3c1 1 2 2.5 2 4z"
      />
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 3v17" />
    </svg>
  )
}
  ...
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={2}
        d="M8 13v6m4-6v6m4-6v6M3 13h18c0-2.21-1.79-4-4-4h-1c0-2.76-2.24-5-5-5S6 6.24 6 9H5c-2.21 0-4 1.79-4 4z"
      />
    </svg>
  )
}
